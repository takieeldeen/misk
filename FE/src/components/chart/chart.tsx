...
const ApexChart = withLoadingProps<WithLoadingProps>((useLoadingProps) => {
  const ChartComponent = dynamic(() => import('react-apexcharts').then((mod) => mod.default), {
    ssr: false,
    loading: () => <div>Loading...</div>,
  });

  const Component: React.FC<WithLoadingProps> = () => {
